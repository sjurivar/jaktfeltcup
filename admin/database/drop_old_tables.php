...
/**
 * Drop Old Tables
 * Remove tables without jaktfelt_ prefix
 */
...
// Set page variables
$page_title = 'Drop Old Tables - Database Admin';
$current_page = 'admin';
$body_class = 'bg-light';
...
try {
    ...
    echo "<h1><i class='fas fa-trash me-2'></i>Drop Old Tables</h1>";
    echo "<p class='lead'>Remove tables without jaktfelt_ prefix</p>";
    
    // Get all tables
    $tables = $pdo->query("SHOW TABLES")->fetchAll(PDO::FETCH_COLUMN);
    
    // Define old tables to drop
